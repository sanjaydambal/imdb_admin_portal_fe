...
const MovieForm = ({ onAdd }) => {
    ...
    return (
        <div className="container" style={{ width: '75%', '@media (min-width: 768px)': { width: '30%' }, '@media (min-width: 1200px)': { width: '25%' } }}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="description" className="form-control" name="description" value={formData.description} onChange={handleChange} required />
                </div>
                <div className="mb-3">
